...
public class JobForm {
    ...
    public JobForm() {
        ...
        */
        ...
        // Populating the other ArrayList collections needed in the view
        locations = jobData.getLocations().findAll();
        coreCompetencies = jobData.getCoreCompetencies().findAll();
        positionTypes = jobData.getPositionTypes().findAll();
        // End populating the other ArrayList collections
    ...
    // getters and setters for fields needed to create new Jobs
